function notifyProductActions(message, bgClass) {
    $("body").append("<div class='add2cart-notification animated fadeIn "+bgClass+"'>"+ message +"</div>");
...
(function () {
    ...
    $(".add2cart-notify").on("click", function () {
        notifyProductActions("Added to cart successfully!");
    });
