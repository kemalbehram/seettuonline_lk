...
Route::prefix('/hype')
->group(base_path('routes/hype.php'));
...
Route::group(['namespace' => 'Seettu', 'as' => 'seettu.'], function() {
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
Route::get('/request', 'CartController@requestProduct')->name('request');
Route::post('/request/submit', 'CartController@requestProductSubmit')->name('request.submit');
...
Route::group(['middleware' => ['checkout']], function(){
    ...
    Route::POST('/checkout/login', 'CheckoutController@login_for_cart')->name('checkout.login');
...
Route::any('/checkout/payment/cod', 'CheckoutController@checkout_cod')->name('payment.checkout.cod');
