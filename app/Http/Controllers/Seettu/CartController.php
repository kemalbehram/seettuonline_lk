...
class CartController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('seettu.view_cart', compact('categories'));
    }

    public function requestProduct(Request $request)
    {
        return view('seettu.product_request_form');
    }
    ...
    public function requestProductSubmit(Request $request)
    {
        ...
        $path = $request->file('product_image')->store('/requested_products');
        $request->product_image = $path;
        
        Mail::to(env('PRODUCT_REQUEST_RECEIVE_EMAIL'))->send(new ProductRequest($request->product_name, $request->product_image, $request->description, $request->fullname, $request->phone, $request->email, $request->shipping));
        
        return redirect()->route('seettu.request')->with('message', 'Your Request have been received');
