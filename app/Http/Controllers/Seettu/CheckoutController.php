...
use App\Http\Controllers\Seettu\OrderController;
...
class CheckoutController extends Controller
{
    ...
    public function checkout_cod(Request $request)
    {
        ...
        flash(translate("Your order has been placed successfully"))->success();
        return redirect()->route('seettu.order_confirmed');
    }
    ...
    public function get_shipping_info(Request $request)
    {
        if (Session::has('cart') && count(Session::get('cart')) > 0) {
            ...
            return view('seettu.shipping_info', compact('categories'));
        }
        flash(translate('Your cart is empty'))->success();
        return back();
    }

    public function login_for_cart(Request $request)
    {
        // dd($request);
        ...
        if($user != null){
            if(Hash::check($request->password, $user->password)){
                ...
                return redirect()->route('seettu.checkout.shipping_info');
            }
        }
        return back();
    }
    ...
    public function store_shipping_info(Request $request)
    {
        ...
        // return view('seettu.store_delivery_info');
        return view('seettu.payment_select', compact('total'));
    }
    ...
    public function login()
    {
        ...
        return view('seettu.user_login_for_cart');
    }
    ...
    public function order_confirmed()
    {
        ...
        return view('seettu.order_confirmed', compact('order'));
    }
}
